...
void bigint_dump_bin(struct bigint_t*);
void bigint_dump_hex(struct bigint_t*);

  /* Math stuff? */
int bigint_eq(struct bigint_t*, struct bigint_t*);
void bigint_clone(struct bigint_t*, struct bigint_t*);
...
void bigint_div(struct bigint_t*, struct bigint_t*);
void bigint_pow(struct bigint_t*, struct bigint_t*);

  /* Modular math stuff? */
void bigint_modpow(struct bigint_t*, struct bigint_t*, struct bigint_t*);
